...
def process_task(q1: Queue):
    ...
    producer_local = KafkaProducer(bootstrap_servers=['35.222.126.116:9094'], api_version=(0, 10))
    while True:
        payload = q1.get()
...
if __name__ == '__main__':
    ...
    for message in consumer:
        ...
        if executable:
            ...
            producer = KafkaProducer(bootstrap_servers=['35.222.126.116:9094'], api_version=(0, 10))
